...
Define the TreeWalker fallback strategy for Windows UIA text grabbing — a depth-first traversal of the UIA control tree used when the primary `GetFocusedElement` path yields no text.
