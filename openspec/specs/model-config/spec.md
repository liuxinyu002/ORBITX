...
Define the CRUD Tauri Commands for AI model configuration management, provider coverage, label uniqueness enforcement, and API key masking rules. This capability provides the backend persistence layer for user-configured AI model endpoints.
