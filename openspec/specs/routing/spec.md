...
Define the React Router v7 nested route tree, header integration for navigation and breadcrumbs, Error Boundary for render crash protection, and Tauri-compatible router mode (HashRouter).
