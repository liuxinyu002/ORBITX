...
Define the full lifecycle management of tasks: create, list, read, update (PATCH semantics), and delete. Tasks are the organizational unit for data extraction, each containing an embedded Schema JSON.
