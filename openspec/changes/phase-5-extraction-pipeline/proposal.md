...
- **Tauri Capability**: `capabilities/default.json` 追加 `core:window:allow-show`、`core:window:allow-set-focus`、`core:window:allow-set-position`（`show_overlay` 命令所需的 overlay 窗口操作权限）
